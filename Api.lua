...
local keyboard = {}
keyboard.inline_keyboard = {{{text = '✪ Group Settings And Management ', callback_data = 'Menu:'..chat_id}},{{text= '✪ Close Directory Management' ,callback_data = 'Exit:'..chat_id}},{{text="✪ Our Team·s Channel",url="https://telegram.me/RexCompany"}}}
AnswerInline(Company.id,'settings','Group settings',chat_id,'✪ Welcome to The Group Manager·s List','Markdown',keyboard)
else
local keyboard = {}
keyboard.inline_keyboard = {{{text="✪ Our Team·s Channel",url="https://telegram.me/RexCompany"}}}			
...
local keyboard = {}
keyboard.inline_keyboard = {{
{text = '✪ Github',url="https://github.com/Rex-Company/Rex-Company"}
},{{text = '✪ Edited By',url="https://telegram.me/Rex_Developer"}
},{{text = '✪ Our Team·s Channel',url="https://telegram.me/RexCompany"}
},{{text = '<< Bᴀᴄᴋ', callback_data = 'english'..chat_id}}}
EditInline(msg.inline_id,'`⇋ Rex Company`\n'..msg.user_first..'',keyboard)
end
...
local keyboard = {}
keyboard.inline_keyboard = {{
{text = 'گیت هاب ❂ ',url="https://github.com/Rex-Company/Rex-Company"}
},{{text = 'ویرایش شده توسط ❂  ',url="https://telegram.me/Rex_Developer"}
},{{text = 'چنل تیم ❂ ',url="https://telegram.me/RexCompany"}
